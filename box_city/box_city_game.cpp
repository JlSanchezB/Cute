...
void BoxCityGame::OnInit()
{
	...
	render::AddGameResource(m_render_system, "IndirectBoxBuffer"_sh32, CreateResourceFromHandle<render::RenderResource>(display::WeakBufferHandle(m_display_resources.m_indirect_box_buffer)));
	render::AddGameResource(m_render_system, "IndirectParametersBuffer"_sh32, CreateResourceFromHandle<render::RenderResource>(display::WeakBufferHandle(m_display_resources.m_indirect_parameters_buffer)));
